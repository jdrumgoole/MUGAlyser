...
class MUG_Analytics(object):
    ...
    def __init__(self, mdb, formatter="json", batchID=None, limit=None, view=None):
        self._mdb = mdb
        audit = Audit(mdb)
    ...
    def get_RSVP_history(self, urls, filename=None):
        ...
        formatter.output(fieldNames=["timestamp", "urlname", "event", "rsvp_count"], datemap=["timestamp"],
                         limit=self._limit)
    ...
    def get_member_history(self, urls, filename=None):
        ...
        formatter = CursorFormatter(agg.aggregate(), filename, self._format)
        formatter.output(fieldNames=["timestamp", "batchID", "urlname", "count"], datemap=["timestamp"],
                         limit=self._limit)
    ...
    def get_groups(self, urls, filename=None):
        ...
        formatter.output(fieldNames=["urlname", "url", "last_event", "members", "city", "country", "founded"],
                         datemap=["last_event", "founded"], limit=self._limit)
